    ...
    */
    ...
    return (react_1.default.createElement("div", { className: 'em-select ' + customClass },
        react_1.default.createElement("div", { className: dropdownClass, id: id && id.constructor === String ? id : 'select-default-id', "data-testid": id && id.constructor === String ? id : 'select-default-id' },
            react_1.default.createElement("div", { className: "em-input-title" }, config.label && config.label != '' &&
                react_1.default.createElement("label", { className: "em-input-label" },
                    config.label,
            ...
            type === 'select' ? (disabled ? (react_1.default.createElement("div", { "data-testid": 'dropdown-icon', className: "em-field-icon" }, Assets_1.SVG_ARROWDOWN)) : (value && value !== "" && !hideClearIcon ? (react_1.default.createElement("div", { "data-testid": 'clear-icon', onClick: function (event) { return clearValuesHandler(event); }, className: 'em-field-icon' },
                react_1.default.createElement("svg", { width: "20", height: "20", viewBox: "0 0 20 20", fill: "none", xmlns: "http://www.w3.org/2000/svg" },
                    react_1.default.createElement("path", { fillRule: "evenodd", clipRule: "evenodd", d: "M3.00005 14.7895L5.21058 17L10 12.2106L14.7895 17.0001L17 14.7895L12.2105 10.0001L17.0001 5.21053L14.7895 3L10 7.78953L5.21053 3.00005L3 5.21058L7.78948 10.0001L3.00005 14.7895Z", fill: "#A0AEC0" })))) : (react_1.default.createElement("div", { "data-testid": 'dropdown-icon', className: "em-field-icon", onClick: function (event) { return popoverRequestHandler(event, 'on-focus'); } }, Assets_1.SVG_ARROWDOWN)))) : null),
