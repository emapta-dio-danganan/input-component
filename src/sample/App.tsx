...
import { InputSelectionHandler, SelectWithDisplay, SelectWithLinks, SelectWithProfile } from '../main/index';


const GROUP_OPTIONS_CONSTANT = {
  'sample-group-1': {
...
const App = () => {
  ...
  return (
    <div style={{padding:'20px'}}>
      ...
      <div>
        <InputSelectionHandler
          config={formElement.sampleInputTime}
          onChanged={(e: any) => inputChangedHandler(e, 'sampleInputTime')}
        />
      </div>
      <br />
      <div>
      ...
      <div>
        ...
        <InputSelectionHandler
          ...
          onChanged={(e: any) => inputChangedHandler(e, 'sampleDateTimepickerSingle')}
        />
      </div>
      <br />
      <div>
      ...
      <div>
        ...
        <InputSelectionHandler
          config={formElement.sampleDatepickerMultiple2}

          onChanged={(e: any) => inputChangedHandler(e, 'sampleDatepickerMultiple2')}
        />
      </div>
      ...
      <div>
        ...
        <InputSelectionHandler
          config={formElement.sampleDatepickerMultiple3}

          onChanged={(e: any) => inputChangedHandler(e, 'sampleDatepickerMultiple3')}
        />
      </div>
      <br />
      <div>
